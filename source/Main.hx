...
class Main extends Sprite 
{
	...
	{	
		...
		InputHelper.init();
		InputHelper.addButton("kick");
		InputHelper.addButton("Keep");
		InputHelper.assignKeyToButton("A", "keep");
		InputHelper.assignKeyToButton("D", "kick");
		InputHelper.assignKeyToButton("LEFT", "keep");
		InputHelper.assignKeyToButton("RIGHT", "kick");
